...
/* ─────────────────────────────────────────── data */
const PRODUCTS = [
  { n: "01", name: "Cajas para comida",      desc: "Hamburguesa, tipo Kentucky, colectiva. Fácil armado, candados de seguridad y resistencia a grasa y humedad.", tags: ["Fácil armado", "Candado seguridad", "Antigrasa"], mock: { src: "/assets/producto-1.png", label: "Caja para hamburguesa" } },
  { n: "02", name: "Contenedores",           desc: "Hot dog, papas a la francesa, flautas y multifunción. Para alimentos calientes o fríos, listos para llevar.",   tags: ["Frío y caliente", "2 tamaños", "Multiusos"], mock: { src: "/assets/producto-2.png", label: "Contenedor para hot dog" } },
  { n: "03", name: "Charolas",               desc: "Para snacks y botanas, con fondo de armado automático. Servido directo, sin perder tiempo en mostrador.",       tags: ["Fondo automático", "Antigrasa", "Servido directo"], mock: { src: "/assets/producto-4.png", label: "Charola para snacks" } },
  { n: "04", name: "Conos",                  desc: "Para crepas y frituras, con rigidez superior que no se rompe. Para alimentos que se disfrutan al momento.",     tags: ["Alta rigidez", "Antigrasa", "Para llevar"], mock: { src: "/assets/producto-6.png", label: "Cono para crepas" } },
];
...
const GALLERY = [
  { src: "/assets/producto-1.png",  label: "Caja para hamburguesa", id: "S001", rows: 2 },
  { src: "/assets/producto-3.png",  label: "Contenedor para papas", id: "S004", rows: 1 },
  { src: "/assets/producto-9.png",  label: "Caja tipo Kentucky",    id: "S008", rows: 1 },
  { src: "/assets/producto-2.png",  label: "Contenedor hot dog",    id: "S002", rows: 1 },
  { src: "/assets/producto-6.png",  label: "Cono para crepas",      id: "S006", rows: 2 },
  { src: "/assets/producto-4.png",  label: "Charola para snacks",   id: "S005", rows: 1 },
  { src: "/assets/producto-10.png", label: "Contenedor multifunción", id: "S009", rows: 1 },
  { src: "/assets/producto-7.png",  label: "Contenedor flautas",    id: "S007", rows: 1 },
];
...
function HeroBadges() {
  return (
    <>
      <div className="absolute -top-4 -left-3 lg:-left-8 rotate-[-7deg] z-10">
        <div className="bg-paper rounded-full pl-1.5 pr-4 py-1.5 flex items-center gap-2.5 shadow-[0_18px_40px_-18px_rgba(24,21,19,.55)]">
          <span className="w-9 h-9 rounded-full bg-blue text-paper inline-flex items-center justify-center"><Icon.leaf className="w-4 h-4" /></span>
          <div className="text-left leading-none">
            <div className="font-mono text-[10px] tracking-[.16em] text-ink/55 uppercase">100%</div>
            <div className="font-sans text-[15px] mt-0.5" style={{ fontWeight: 800, letterSpacing: "-0.02em" }}>Biodegradable</div>
          </div>
        </div>
      </div>
      <div className="absolute -bottom-4 right-1 rotate-[5deg] z-10">
        <div className="bg-red text-paper rounded-full px-4 py-2.5 shadow-[0_18px_40px_-18px_rgba(225,29,42,.7)] flex items-center gap-2">
          <span className="font-sans" style={{ fontWeight: 800, fontSize: 15, letterSpacing: "-0.01em" }}>Hecho en México</span>
...
function Hero() {
  const kicker = (
    <div className="flex items-center gap-3 font-mono text-[11px] tracking-[.2em] uppercase font-bold text-ink">
      <span className="inline-flex items-center gap-2 bg-ink text-gold px-3 py-1.5 rounded-full">
        <Icon.flame className="w-3.5 h-3.5" /> Box for fast food
      </span>
      <span className="hidden sm:inline text-ink/60">Hecho en México · desde 2009</span>
    </div>
  );
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          <div className="lg:col-span-7">
            ...
            <div className="mt-9 flex flex-col sm:flex-row gap-3 sm:items-center">
              <Link href="/contacto" className="btn btn-primary">Cotiza mi pedido <Icon.arrow className="w-4 h-4" /></Link>
              <Link href="/catalogo" className="btn btn-secondary">Ver catálogo</Link>
              <span className="hidden lg:flex items-center gap-2 ml-2 text-[13px] text-ink/65 font-mono font-bold">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative grid grid-cols-6 gap-3" style={{ minHeight: 420 }}>
              <div className="col-span-4 row-span-2 relative"><ProductMockup src="/assets/producto-1.png" label="Caja para hamburguesa" aspect="4/5" note="S001" className="shadow-[0_24px_50px_-24px_rgba(24,21,19,.55)]" /></div>
              <div className="col-span-2 relative -mt-6"><ProductMockup src="/assets/producto-3.png" label="Contenedor para papas" aspect="1/1" note="S004" className="shadow-[0_18px_40px_-22px_rgba(24,21,19,.5)]" /></div>
              <div className="col-span-2 relative"><ProductMockup src="/assets/producto-6.png" label="Cono para crepas" aspect="1/1.1" note="S006" className="shadow-[0_18px_40px_-22px_rgba(24,21,19,.5)]" /></div>
              <div className="col-span-3 relative -ml-2 translate-y-3"><ProductMockup src="/assets/producto-9.png" label="Caja tipo Kentucky" aspect="3/2" note="S008" className="shadow-[0_18px_40px_-22px_rgba(24,21,19,.5)]" /></div>
              <div className="col-span-3 relative translate-y-2"><ProductMockup src="/assets/producto-4.png" label="Charola para snacks" aspect="3/2" note="S005" className="shadow-[0_18px_40px_-22px_rgba(24,21,19,.5)]" /></div>
            </div>
            <HeroBadges />
          </div>
        </div>
        <div className="mt-14 lg:mt-20 flex items-center gap-3 text-ink/70">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-6">
          {items.map((it, i) => (
            <div key={i} className="reveal flex flex-col md:items-start gap-3 md:pl-8 md:border-l md:border-ink/15 first:md:border-l-0 first:md:pl-0">
              ...
              <div className="font-serif text-[20px] lg:text-[22px] text-ink" style={{ fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.01em" }}>{it.label}</div>
      ...
      <div className="mx-auto max-w-site px-6 lg:px-10 py-24 lg:py-32">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16 reveal">
          ...
          <p className="text-ink/70 lg:max-w-sm text-[16px] lg:text-[17px] font-medium" style={{ lineHeight: 1.55 }}>
            Troquelamos y armamos en cartulina kraft y sulfatada. Tú eliges la pieza, el tamaño y tu marca; nosotros la hacemos resistir grasa, humedad y prisas.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {PRODUCTS.map((p, i) => (
            <article key={p.n} className="reveal lift bg-paper rounded-xl border border-ink/8 overflow-hidden" style={{ transitionDelay: `${i*60}ms` }}>
              <div className="overflow-hidden"><ProductMockup src={p.mock.src} label={p.mock.label} aspect="4/3" bg="#FFF7E6" /></div>
              <div className="p-6 lg:p-8">
                <div className="flex items-center justify-between mb-3">
                  <span className="label-mono">{p.n} · FAMILIA</span>
                ...
                <h3 className="font-serif text-ink" style={{ fontWeight: 800, fontSize: "clamp(1.5rem, 2.4vw, 2.1rem)", letterSpacing: "-0.025em", lineHeight: 1.1 }}>{p.name}</h3>
                ...
                <Link href="/productos" className="mt-6 inline-flex items-center gap-2 font-bold text-red hover:gap-3 transition-all">Ver más <Icon.arrow className="w-4 h-4" /></Link>
              </div>
            </article>
          ))}
        </div>
...
function Eco() {
  ...
  return (
    <section className="relative grain" style={{ background: "#1BA2DD" }}>
      <div className="mx-auto max-w-site px-6 lg:px-10 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          <div className="lg:col-span-7 reveal">
            <span className="pill-eco mb-8 !bg-ink !text-gold"><Icon.leaf className="w-3.5 h-3.5" /> Compromiso eco</span>
            <h2 className="font-serif text-paper" style={{ fontWeight: 900, letterSpacing: "-0.035em", lineHeight: .95, fontSize: "clamp(2.6rem, 6vw, 5rem)" }}>
            ...
            <div className="mt-10 flex items-center gap-4 flex-wrap">
              ...
              <span className="px-3 py-1.5 bg-paper text-ink rounded-full font-mono text-[12px] tracking-wider font-bold">FDA · GRADO ALIMENTICIO</span>
              <span className="px-3 py-1.5 bg-paper text-ink rounded-full font-mono text-[12px] tracking-wider font-bold">FSC · PAPEL TRAZABLE</span>
            </div>
          </div>
          <div className="lg:col-span-5 space-y-1 reveal">
            {items.map((it, i) => {
              ...
              return (
                <div key={i} className="flex items-start gap-5 py-7 border-b border-paper/25 last:border-b-0">
                  <div className="shrink-0 w-12 h-12 rounded-full bg-paper text-blue inline-flex items-center justify-center"><IconC className="w-5 h-5" /></div>
                  <div>
                    <div className="font-serif text-[22px] text-paper" style={{ fontWeight: 800, letterSpacing: "-0.015em" }}>{it.title}</div>
                    <div className="mt-1 text-paper/80 text-[15px]" style={{ lineHeight: 1.55 }}>{it.body}</div>
                  </div>
                </div>
              );
            })}
    ...
    <section id="catalogo" className="bg-cream">
      <div className="mx-auto max-w-site px-6 lg:px-10 py-24 lg:py-32">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-12 reveal">
          ...
          <Link href="/catalogo" className="btn btn-secondary self-start lg:self-auto">Ver catálogo completo <Icon.arrow className="w-4 h-4" /></Link>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-4 auto-rows-[140px] md:auto-rows-[170px] lg:auto-rows-[200px]">
          {GALLERY.map((g, i) => (
            <div key={i} className={`reveal lift overflow-hidden rounded-2xl group relative ${g.rows === 2 ? "row-span-2" : ""}`} style={{ transitionDelay: `${i*40}ms` }}>
              <ProductMockup src={g.src} label={g.label} aspect="auto" className="!h-full" bg="#FFFFFF" />
              <div className="absolute inset-x-0 bottom-0 p-3 bg-gradient-to-t from-ink/85 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="font-mono text-[10px] tracking-[.16em] uppercase text-gold">{g.id}</div>
                <div className="font-sans text-paper text-[14px] leading-tight" style={{ fontWeight: 700 }}>{g.label}</div>
              </div>
            </div>
          ))}
        </div>
...
function Testimonial() {
  return (
    <section className="grain relative" style={{ background: "#FDC42D" }}>
      <div className="mx-auto max-w-site px-6 lg:px-10 py-24 lg:py-32">
    ...
    <section className="bg-tortilla text-paper relative overflow-hidden">
      ...
      <div className="mx-auto max-w-site px-6 lg:px-10 py-12 lg:py-16 flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10 relative">
        ...
        <div className="flex-1">
          ...
          <p className="mt-3 text-paper/85 text-[16px] lg:text-[17px] max-w-2xl">En tu primera orden de 5,000 piezas o más, nuestro equipo creativo arma tu arte sin costo extra. Aplica en cajas, contenedores, charolas y conos.</p>
        </div>
        <Link href="/contacto" className="btn btn-tortilla shrink-0">Aprovéchalo <Icon.arrow className="w-4 h-4" /></Link>
      </div>
    </section>
  );
}
...
function ContactCTA() {
  const [form, setForm] = useState({ nombre: "", empresa: "", whatsapp: "", necesidad: "cajas", mensaje: "" });
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="lift block bg-cream rounded-xl p-7 border border-ink/8">
              ...
              <div className="mt-5 rounded-md overflow-hidden border border-ink/10 relative" style={{ aspectRatio: "3/1" }}>
                <svg viewBox="0 0 300 100" className="w-full h-full" preserveAspectRatio="none">
                  <rect width="300" height="100" fill="#FFFDF7" />
                  ...
                  <g transform="translate(150,52)">
                    <circle r="12" fill="#E11D2A" opacity=".18" /><circle r="6" fill="#E11D2A" /><circle r="2" fill="#FFFDF7" />
                  </g>
                </svg>
          ...
          <form onSubmit={onSubmit} className="lg:col-span-7 reveal bg-ink rounded-xl p-8 lg:p-12 text-paper relative overflow-hidden">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 relative">
              ...
              <div><label className="block font-mono text-[10.5px] tracking-[.16em] uppercase text-paper/55 mb-2">¿Qué necesitas?</label>
                <select value={form.necesidad} onChange={set("necesidad")} className="field !bg-paper/95 !text-ink">
                  <option value="cajas">Cajas para comida</option><option value="contenedores">Contenedores</option>
                  <option value="charolas">Charolas</option><option value="conos">Conos</option><option value="temporada">Línea de temporada</option><option value="otro">Otro</option>
                </select>
              </div>
            ...
            <div className="mt-7 flex flex-col sm:flex-row sm:items-center gap-4">
              <button type="submit" className="btn btn-primary !bg-leaf hover:!bg-[#B3121C]">{sent ? "¡Recibido!" : "Enviar cotización"} <Icon.arrow className="w-4 h-4" /></button>

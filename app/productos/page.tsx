...
const LINES = [
  {
    ...
    tagline: "Una caja que abre bien, cierra mejor y aguanta el viaje.",
    desc: "Cajas troqueladas para hamburguesa, pollo tipo Kentucky y pedidos colectivos. Fácil armado, candados de seguridad para que no se abran y resistencia a grasa y humedad.",
    specs: [
      { k: "Material", v: "Cartulina kraft · sulfatada" },
      { k: "Cierre", v: "Candado de seguridad" },
      { k: "Resistencia", v: "Grasa y humedad" },
      { k: "Tirajes", v: "Desde 500 piezas" },
      { k: "Impresión", v: "1 a 4 tintas · tu marca" },
      { k: "Tiempo", v: "12–18 días hábiles" },
    ],
    bullets: ["Armado rápido sin pegamento", "Candados que evitan que se abran", "Hamburguesa, Kentucky y colectiva"],
    mocks: [
      { src: "/assets/producto-1.png", label: "Caja para hamburguesa", aspect: "4/5" },
      { src: "/assets/producto-9.png", label: "Caja tipo Kentucky", aspect: "1/1" },
      { src: "/assets/producto-8.png", label: "Caja colectiva", aspect: "1/1" },
    ],
    accent: "#E11D2A",
  },
  {
    ...
    n: "02",
    name: "Contenedores",
    tagline: "Para lo que se disfruta al momento.",
    desc: "Contenedores para hot dog, papas a la francesa, flautas y usos múltiples. Resistentes a la grasa, para alimentos calientes o fríos y disponibles en varios tamaños.",
    specs: [
      { k: "Material", v: "Cartulina kraft · sulfatada" },
      { k: "Temperatura", v: "Alimentos fríos o calientes" },
      { k: "Tamaños", v: "Hasta 2 medidas por modelo" },
      { k: "Tirajes", v: "Desde 500 piezas" },
      { k: "Impresión", v: "1 a 4 tintas · tu marca" },
      { k: "Tiempo", v: "12–18 días hábiles" },
    ],
    bullets: ["Resistente a la grasa", "Frío o caliente, sin problema", "Hot dog, papas, flautas y más"],
    mocks: [
      { src: "/assets/producto-2.png", label: "Contenedor hot dog", aspect: "4/5" },
      { src: "/assets/producto-3.png", label: "Contenedor para papas", aspect: "1/1" },
      { src: "/assets/producto-7.png", label: "Contenedor para flautas", aspect: "1/1" },
    ],
    accent: "#1BA2DD",
  },
  {
    id: "charolas",
    n: "03",
    name: "Charolas y conos",
    tagline: "Servido directo, sin perder tiempo en mostrador.",
    desc: "Charolas para snacks con fondo de armado automático y conos rígidos para crepas y frituras. Rigidez superior que no se rompe, lista para servir y para llevar.",
    specs: [
      { k: "Material", v: "Cartulina kraft · sulfatada" },
      { k: "Fondo", v: "Armado automático" },
      { k: "Rigidez", v: "Superior · no se rompe" },
      { k: "Tirajes", v: "Desde 500 piezas" },
      { k: "Impresión", v: "1 a 4 tintas · tu marca" },
      { k: "Tiempo", v: "10–15 días hábiles" },
    ],
    bullets: ["Fondo de armado automático", "Conos que no se rompen", "Snacks, botanas, crepas y frituras"],
    mocks: [
      { src: "/assets/producto-4.png", label: "Charola para snacks", aspect: "4/5" },
      { src: "/assets/producto-5.png", label: "Charola fondo automático", aspect: "1/1" },
      { src: "/assets/producto-6.png", label: "Cono para crepas", aspect: "1/1" },
    ],
    accent: "#F2A50E",
  },
  {
    ...
    desc: "Cualquiera de nuestras piezas, vestida para la ocasión: Día de Muertos, Navidad, San Valentín y fechas patrias. Diseños listos o personalizados a tu marca, en tirajes cortos.",
    specs: [
      { k: "Fechas", v: "Muertos · Navidad · 14 Feb · 16 Sep" },
      { k: "Piezas", v: "Cajas · contenedores · charolas" },
    ...
    bullets: ["Diseños originales año con año", "Reservación de cupos en alta temporada", "Combo de piezas con descuento"],
    mocks: [
      { src: "/assets/producto-10.png", label: "Contenedor multifunción", aspect: "4/5" },
      { src: "/assets/producto-1.png", label: "Caja para hamburguesa", aspect: "1/1" },
      { src: "/assets/producto-9.png", label: "Caja tipo Kentucky", aspect: "1/1" },
    ],
    accent: "#181513",
  },
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 ${flip ? "lg:flex-row-reverse" : ""}`}>
          ...
          <div className={`lg:col-span-6 ${flip ? "lg:order-2" : ""} reveal`}>
            <div className="grid grid-cols-6 gap-3">
              <div className="col-span-4 row-span-2"><ProductMockup src={line.mocks[0].src} label={line.mocks[0].label} aspect={line.mocks[0].aspect} note={`${line.n} · ${line.name}`} bg="#FFFFFF" /></div>
              <div className="col-span-2"><ProductMockup src={line.mocks[1].src} label={line.mocks[1].label} aspect={line.mocks[1].aspect} bg="#FFFFFF" /></div>
              <div className="col-span-2"><ProductMockup src={line.mocks[2].src} label={line.mocks[2].label} aspect={line.mocks[2].aspect} bg="#FFFFFF" /></div>
            </div>
          </div>
          {/* copy */}
          <div className={`lg:col-span-6 ${flip ? "lg:order-1" : ""} reveal`}>
            ...
            <h2 className="font-serif text-ink" style={{ fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 0.98, fontSize: "clamp(2.4rem, 5vw, 4rem)" }}>
              {line.name}
            </h2>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link href="/contacto" className="btn btn-primary">Cotizar esta línea <Icon.arrow className="w-4 h-4" /></Link>
              <Link href="/catalogo" className="btn btn-secondary">Ver muestras</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-site px-6 lg:px-10 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4 reveal">
            ...
            <h2 className="font-serif text-ink" style={{ fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 0.98, fontSize: "clamp(2.2rem, 4.5vw, 3.5rem)" }}>

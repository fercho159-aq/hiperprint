...
function Channels() {
  const channels = [
    { i: "phone" as const, k: "01", t: "Llámanos", main: "55 5087 5427", sub: "L–V 9:00–18:00 · Sáb 10–14", href: "tel:5550875427" },
    { i: "wa" as const, k: "02", t: "WhatsApp", main: "+52 55 5087 5427", sub: "Respuesta promedio: 12 min", href: "https://wa.me/525550875427" },
    { i: "mail" as const, k: "03", t: "Escríbenos", main: "ventas@hiperprint.mx", sub: "Cotización en < 24 h", href: "mailto:ventas@hiperprint.mx" },
  ];
  return (
      ...
      <div className="mx-auto max-w-site px-6 lg:px-10 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <aside className="lg:col-span-4 reveal">
            ...
            <h2 className="font-serif text-ink" style={{ fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 0.98, fontSize: "clamp(2rem, 4.5vw, 3.4rem)" }}>
              Llena el formulario.<br /><em style={{ fontWeight: 500, color: "#E11D2A" }}>Te respondemos hoy.</em>
            </h2>
                ...
                {step === 1 && (
                  <div className="space-y-7 relative">
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-paper/15">
                      ...
                      <button type="button" onClick={() => setStep(2)} className="btn btn-primary !bg-leaf hover:!bg-[#B3121C]">Continuar <Icon.arrow className="w-4 h-4" /></button>
                    </div>
                  </div>
                )}
                ...
                {step === 2 && (
                  <div className="space-y-6 relative">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-4 border-t border-paper/15">
                      ...
                      <button type="submit" className="btn btn-primary !bg-leaf hover:!bg-[#B3121C]">Enviar cotización <Icon.arrow className="w-4 h-4" /></button>
                    </div>
            ...
            {sent && (
              <div className="text-center py-10 relative">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
                  <Link href="/catalogo" className="btn btn-primary !bg-leaf">Ver catálogo <Icon.arrow className="w-4 h-4" /></Link>
      ...
      <div className="mx-auto max-w-site px-6 lg:px-10 py-24 lg:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          <div className="lg:col-span-5 reveal">
            ...
            <h2 className="font-serif text-ink" style={{ fontWeight: 700, letterSpacing: "-0.03em", lineHeight: 0.98, fontSize: "clamp(2rem, 4.5vw, 3.4rem)" }}>
              La planta está abierta.<br /><em style={{ fontWeight: 500, color: "#E11D2A" }}>Date una vuelta.</em>
            </h2>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-3">
              ...
              <Link href="/contacto#cotizar" className="btn btn-secondary">Agendar visita</Link>
            </div>
          </div>
            ...
            <div className="rounded-xl overflow-hidden border border-ink/12 relative bg-cream" style={{ aspectRatio: "4/3" }}>
              <svg viewBox="0 0 400 300" className="w-full h-full" preserveAspectRatio="xMidYMid slice">
                ...
                <g transform="translate(200,150)">
                  <circle r="32" fill="#E11D2A" opacity=".12" />
                  <circle r="20" fill="#E11D2A" opacity=".22" />
                  <circle r="10" fill="#E11D2A" />
                  <circle r="3.5" fill="#FFFDF7" />
                  <rect x="-44" y="-58" width="88" height="22" rx="3" fill="#1A1A1A" />
                  <text x="0" y="-43" textAnchor="middle" className="font-mono" fill="#FFFDF7" style={{ fontSize: 8.5, letterSpacing: ".08em" }}>HIPERPRINT · 91</text>
                </g>
                {/* labels */}
    ...
    <section className="bg-cream border-t border-ink/10">
      <div className="mx-auto max-w-site px-6 lg:px-10 py-20 lg:py-24">
        <div className="flex items-end justify-between mb-10 reveal">
          ...
          <Link href="/productos#faq" className="hidden md:inline-flex items-center gap-2 font-medium text-leaf hover:gap-3 transition-all">Ver todas <Icon.arrow className="w-4 h-4" /></Link>
        </div>
